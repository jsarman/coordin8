...
func (UnimplementedRegistryServiceServer) ModifyAttrs(context.Context, *ModifyAttrsRequest) (*Capability, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ModifyAttrs not implemented")
}
...
func (UnimplementedRegistryServiceServer) LookupAll(*LookupRequest, grpc.ServerStreamingServer[Capability]) error {
	return status.Errorf(codes.Unimplemented, "method LookupAll not implemented")
}
